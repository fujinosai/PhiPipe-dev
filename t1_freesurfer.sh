...
then
     ...
     recon-all -s ${SUBJECT} -autorecon2 -careg # https://www.mail-archive.com/freesurfer@nmr.mgh.harvard.edu/msg74523.html add -careg to avoid ERROR: cannot find or read transforms/talairach.m3z  
